...
public class PlayfulAStarOpponentAgent implements Agent
{
    protected boolean action[] = new boolean[Environment.numberOfButtons];
    protected String name = "Playful_AStarAgent";
    private AStarSimulator sim;
    private int tickCounter = 0;
    private float lastX = 0;
    private float lastY = 0;
	int errCount = 0;
	PlayfulAStarOpponentAgent errAgent;
    public void reset()
    {
